...
const groups: { title: string; note: string; items: Item[] }[] = [
  ...
  },
  {
    ...
    note: "Настройки пространства, профиль, модули установки и уведомления.",
    items: [
      { to: "/settings/space", title: "Настройки пространства", note: "Общие, участники и роли, теги, модули и вид наблюдателя." },
      { to: "/settings/profile", title: "Профиль и уведомления", note: "Данные, оформление, пароль и каналы уведомлений." },
      { to: "/admin/modules", title: "Модули системы", note: "Состояние и включение модулей на всю установку." },
      { to: "/notifications", title: "Центр уведомлений", note: "Упоминания, назначения, приёмка и комментарии." },
    ],
  },
  {
    title: "Системные состояния",
    note: "Пустые экраны, ошибки и мобильная сборка.",
    items: [
      { to: "/states/empty", title: "Пустые состояния", note: "Девять мест без данных, каждое с одним действием." },
      { to: "/states/errors", title: "Ошибки и потеря сети", note: "403, 404, 500 и очередь изменений без сети." },
      { to: "/states/mobile", title: "Мобильная сборка", note: "Ключевые экраны в рамке 390 px." },
    ],
  },
];
